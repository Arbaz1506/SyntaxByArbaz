    ...
    <section id="about" className="about-section">
      ...
      <div className="about-card">
        ...
        <div className="text-side">
          ...
          <p>
            My roots lie in <strong>C++</strong> and problem-solving. With 300+ problems solved on platforms like <strong>LeetCode</strong> and <strong>AtCoder</strong>, I’ve built a strong base in <span className="highlight">DSA, logic, and clean code</span>.
          </p>
          <p>
