    ...
    <section id="home" className="home-section">
      ...
      <div className="home-content">
        ...
        <div className="social-icons">
          ...
          <a href="https://drive.google.com/file/d/1p_EkEDg5GyDzoyDVt9vkuptX6zT6XI3p/view?usp=drive_link" target="_blank" rel="noopener noreferrer" title="View/Download Resume"><FaFileAlt /></a>
